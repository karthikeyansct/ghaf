...
# SPDX-License-Identifier: Apache-2.0
{
  ...
  package = pkgs.systemdMinimal.override {
    ...
    withLibseccomp = true;
    withLogind = true;
    withMachined = cfg.withContainers;
  ...
  suppressedSystemUnits =
    ...
    ++ (lib.optionals ((!cfg.withDebug) && (!cfg.withContainers)) [
  ...
  with lib; {
    ...
    options.ghaf.systemd.base = {
      ...
      withContainers = mkOption {
        description = "Enable systemd container and machined/importd functionality.";
        type = types.bool;
        default = false;
      };
